// ════════════════════════════════════════════════════════════════════════════
// run7.js — Parallel scraper worker #7
//
// See run1.js for the full explanation — this file is functionally
// identical to run1.js/run2.js/run3.js/run4.js/run5.js/run6.js. The only
// difference between all seven run*.js files is the WORKER_ID value passed
// to unified_scraper.js (here: '7') and the matching "Starting Worker N..."
...
console.log('🗺️  Starting Worker 7...\n');
// WORKER_ID=7 tells unified_scraper.js which shard of cities/keywords this
// particular worker instance should handle.
const child = spawn('node', ['unified_scraper.js'], {
  cwd: __dirname,
  stdio: 'inherit',
  env: { ...process.env, WORKER_ID: '7' }
});
